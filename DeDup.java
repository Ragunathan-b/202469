public class DeDup {
	...
	int[] arryUniqueInt =  removeDuplicate( randomIntegers  );
	System.out.println("Approach 1 Duplicate removed Array : " + arryUniqueInt);
	arryUniqueInt =  removeDuplicateApproach2( randomIntegers  );
	System.out.println("Approach 2 Duplicate removed Array: " + arryUniqueInt);
	arryUniqueInt =  removeDuplicateInsertionOrder( randomIntegers  );
	System.out.println("Approach 3 Duplicate removed Array with orginal order : " + arryUniqueInt);
    }
